// Date last modified =  20110725
// Modified by =  DC

var lpMTagConfig = {
	'lpServer' : lpServer,
    'lpNumber' : lpAccountNumber,
	'lpProtocol' : (document.location.toString().indexOf('https:')==0) ? 'https' : 'http',
	'lpTagLoaded' : false,
	'lpTagSrv' : 'sr4.liveperson.net', //uncomment for hosted solution (erase this line if not needed)
...
try{
var lpSecure ="";
if (lpMTagConfig.lpProtocol=="https"){
	lpSecure="-secured";
}
}catch(e){}
try{
	if (typeof(lpLocale)=="undefined")	var lpLocale='uk';
	if(typeof(lpAddVars)!="undefined")	lpAddVars('page','locale',lpLocale);
	...
	lpMTagConfig.defaultInvite ='chat'+'-'+lpLocale+'-'+lpUnit+lpSecure;
}catch(e){}
...
// LP Button Code-
if(typeof(lpMTagConfig.dynButton)!="undefined") {
	lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"chat-"+lpLocale+"-"+lpUnit+"-catalogue"+lpSecure,"pid":"buttonDIVcatalogue","afterStartPage": true};
	lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"chat-"+lpLocale+"-"+lpUnit+"-checkout"+lpSecure,"pid":"buttonDIVcheckout","afterStartPage": true};
}